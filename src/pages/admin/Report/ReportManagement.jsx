...
const ReportsManagement = () => {
  ...
  const filteredEnquiries = filteredByReportType.filter((item) => {
    if (searchQuery) {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(18);
    doc.text("Enquiry Report", 14, 15);
    doc.setFontSize(10);
    doc.text(`Generated On : ${new Date().toLocaleString()}`, 14, 22);
    doc.text(`Report : ${activeReportFilter}`, 14, 30);
    ...
    autoTable(doc, {
      ...
      body: filteredEnquiries.map((item) => [
        item.id,
        item.name,
        item.email,
        item.event,
  ...
  const handleExportSummary = () => {
    ...
    autoTable(doc, {
      ...
      head: [["Metric", "Value"]],
      body: [
        ["Total Enquiries", "1,284"],
        ["Total Bookings", "847"],
        ["Total Payments", "8,42,500"],
        ["GST Collected", "1,51,650"],
        ["Current Report", activeReportFilter],
      ],
    });
    ...
    <div className="container-fluid px-0 py-3">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap">
        ...
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <button className="dashboard-btn-outline" style={{ marginTop: "10px" }}>
            <FaRegCalendarAlt />
          ...
          >
            <div className="card-body px-4 py-2">
              <div className="d-flex align-items-center gap-3 mb-3">
                ...
                <h2
                  className="mb-0"
                  style={{ fontSize: "24px", fontWeight: "700", lineHeight: "32px", color: "#111827" }}
                >
                  1,284
                </h2>
              </div>
              ...
              <small
                className="mt-auto"
                style={{ fontSize: "11px", fontWeight: "500", color: "#10B981" }}
              >
                ↗ +18% vs last month
              </small>
            </div>
      ...
      {showFilter && (
        <div
          className="mb-3 p-3"
          style={{ border: "1px solid #E5E7EB", borderRadius: "12px", background: "#fff" }}
        >
          <div className="d-flex flex-wrap align-items-center gap-2 gap-md-3 justify-content-start justify-content-lg-end">
            ...
            <div className="filter-capsule-container">
              ...
              <span className="filter-clear-btn" onClick={() => setPriorityFilter("")}>
                Clear All
              </span>
            </div>
          ...
          >
            <button
              ...
              style={{
                ...
                border: activeReportFilter === "All" ? "1px solid #A7F3D0" : "1px solid #D1D5DB",
              }}
            >
              All
            </button>
            <button
              ...
              style={{
                background: activeReportFilter === "Enquiry Report" ? "#D1FAE5" : "#FFFFFF",
                color: activeReportFilter === "Enquiry Report" ? "#0F9D8A" : "#6B7280",
                border: activeReportFilter === "Enquiry Report" ? "1px solid #A7F3D0" : "1px solid #D1D5DB",
              }}
            >
              Enquiry Report
            </button>
            <button
              ...
              style={{
                background: activeReportFilter === "Booking Report" ? "#D1FAE5" : "#FFFFFF",
                color: activeReportFilter === "Booking Report" ? "#0F9D8A" : "#6B7280",
                border: activeReportFilter === "Booking Report" ? "1px solid #A7F3D0" : "1px solid #D1D5DB",
              }}
            >
              Booking Report
            </button>
            <button
              ...
              style={{
                ...
                border: activeReportFilter === "GST Report" ? "1px solid #A7F3D0" : "1px solid #D1D5DB",
              }}
            >
              GST Report
            </button>
            <button
              ...
              style={{
                ...
                border: activeReportFilter === "Payment Report" ? "1px solid #A7F3D0" : "1px solid #D1D5DB",
              }}
            >
              Payment Report
            </button>
              ...
              <tbody>
                {currentEnquiries.map((item) => (
                  <tr key={item.id} style={{ height: "76px" }}>
                    ...
                    <td>
                      <div style={{ fontSize: "12px", fontWeight: 600 }}>{item.id}</div>
          ...
          <div className="d-flex justify-content-between align-items-center flex-wrap gap-2 mt-3">
            ...
            <nav className="d-flex align-items-center gap-2 flex-wrap">
              ...
              {getPageNumbers().map((p, index) =>
                p === "..." ? (
                  <span key={`dots-${index}`} className="mx-1 text-muted">
                    ...
                  </span>
                ) : (
                  <button
      ...
      {/* Bottom Section: Generate Report + History */}
            ...
            <div className="card-body p-4 p-md-5">
              ...
              <div className="row align-items-start">
                <div className="col-md-6">
                  <label
                    className="fw-semibold text-uppercase mb-3 d-block"
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12 col-sm-6">
                      <button
                        ...
                        style={{ background: "#0F9D8A", height: "50px", borderRadius: "12px" }}
                      >
                    ...
                    <div className="col-12 col-sm-6">
                      <button
                        className="btn w-100 text-white fw-semibold d-flex align-items-center justify-content-center gap-2"
                        style={{ background: "#DC2626", height: "50px", borderRadius: "12px" }}
                      >
          ...
          <div className="card border-0 shadow-sm h-100" style={{ borderRadius: "16px" }}>
            <div className="card-body p-3 p-md-4">
              ...
              >
                <div className="d-flex align-items-center gap-3">
                  ...
                  <div>
                    <div
                      ...
                      style={{ fontSize: "15px", maxWidth: "170px" }}
                    >
                ...
                <FaDownload size={18} color="#6B7280" className="ms-2 flex-shrink-0" />
              </div>
              {/* Excel */}
              <div
              ...
              >
                <div className="d-flex align-items-center gap-2">
                  ...
                  <div>
                    ...
                    <small className="text-muted">11 MB • Generated yesterday</small>
                  </div>
                </div>
